  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center py-12">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">{t.home.title}</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">{t.home.description}</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <div className="flex items-center space-x-2 text-gray-600">
            ...
            <span className="font-medium">{t.home.creditsPerGeneration}</span>
          </div>
        </div>
      </div>
      ...
      {history.length > 0 && (
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-800">{t.home.recentCreations}</h2>
            <button
          ...
          {history[0] && (
            <div className="mt-4 p-4 bg-gray-50 rounded-xl">
              <div className="text-sm text-gray-600 mb-1">{t.home.latestPrompt}</div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <h3 className="text-xl font-bold mb-2">{t.home.generateImages}</h3>
          <p className="text-blue-100">{t.home.generateDescription}</p>
        </div>
        ...
        >
          ...
          <h3 className="text-xl font-bold mb-2">{t.home.rechargeCredits}</h3>
          <p className="text-green-100">{t.home.rechargeDescription}</p>
        </div>
      </div>
    </div>
  );
